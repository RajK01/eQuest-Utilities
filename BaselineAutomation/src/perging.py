...
def perging_data_weekly(data):
    start_marker = "Week Schedules"
    end_marker = "Annual Schedules"
    delete_marker = "WEEK-SCHEDULE-PD"
...
def perging_data_day(data):
    start_marker = "Day Schedules"
    end_marker = "Week Schedules"
    delete_marker = "DAY-SCHEDULE-PD"
